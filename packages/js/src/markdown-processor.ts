 ...
 */
function mayNeedGfmTextEscape(value: string, buffer: string[], depthMap: Uint16Array, baseIndent = 0): boolean {
 ...
 */
function escapeGfmText(value: string, buffer: string[], depthMap: Uint16Array, baseIndent = 0): string {
  const inTable = Boolean(depthMap[TAG_TABLE])
  const inLink = Boolean(depthMap[TAG_A])
