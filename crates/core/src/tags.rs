...
const BLOCK_NO_SPACING: TagHandler = TagHandler {
...
static TAG_HANDLERS: [Option<TagHandler>; MAX_TAG_ID] = {
  ...
  // HEAD
  t[TAG_HEAD as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    spacing: Some(NO_SPACING),
    ..NONE
  });
  ...
  t[TAG_TITLE as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    is_non_nesting: true,
    spacing: Some(NO_SPACING),
    ..NONE
  });
  t[TAG_SCRIPT as usize] = Some(TagHandler {
    excludes_text_nodes: true,
    is_non_nesting: true,
    ..NONE
  });
  t[TAG_STYLE as usize] = Some(TagHandler {
    is_non_nesting: true,
    excludes_text_nodes: true,
    ..NONE
  });
  t[TAG_META as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    is_self_closing: true,
    spacing: Some(NO_SPACING),
  ...
  // Headings
  t[TAG_H1 as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    ..NONE
  });
  t[TAG_H2 as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    ..NONE
  });
  t[TAG_H3 as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    ..NONE
  });
  t[TAG_H4 as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    ..NONE
  });
  t[TAG_H5 as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    ..NONE
  });
  t[TAG_H6 as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    ..NONE
  });

  t[TAG_HR as usize] = Some(TagHandler {
    is_self_closing: true,
    ..NONE
  });
  ...
  t[TAG_S as usize] = Some(INLINE_COLLAPSE);
  t[TAG_STRIKE as usize] = Some(INLINE_COLLAPSE);
  t[TAG_SUB as usize] = Some(INLINE_COLLAPSE);
  t[TAG_SUP as usize] = Some(INLINE_COLLAPSE);
  t[TAG_INS as usize] = Some(INLINE_COLLAPSE);

  t[TAG_BLOCKQUOTE as usize] = Some(TagHandler {
    spacing: Some(BLOCKQUOTE_SPACING),
    ..NONE
  });
  t[TAG_CODE as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    spacing: Some(NO_SPACING),
    is_inline: true,
    needs_attributes: true,
  ...
  // Links & images
  t[TAG_A as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    spacing: Some(NO_SPACING),
    is_inline: true,
    needs_attributes: true,
  ...
  t[TAG_THEAD as usize] = Some(TagHandler {
    spacing: Some(TABLE_ROW_SPACING),
    excludes_text_nodes: true,
    ..NONE
  });
  t[TAG_TR as usize] = Some(TagHandler {
    excludes_text_nodes: true,
    spacing: Some(TABLE_ROW_SPACING),
    ..NONE
  });
  ...
  t[TAG_TBODY as usize] = Some(TagHandler {
    spacing: Some(NO_SPACING),
    excludes_text_nodes: true,
    ..NONE
  });
  t[TAG_TFOOT as usize] = Some(TagHandler {
    spacing: Some(TABLE_ROW_SPACING),
    excludes_text_nodes: true,
    ..NONE
  });
  ...
  t[TAG_ADDRESS as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    spacing: Some(NO_SPACING),
    ..NONE
  });
  ...
  t[TAG_DT as usize] = Some(TagHandler {
    collapses_inner_white_space: true,
    spacing: Some([0, 1]),
    ..NONE
  });
  t[TAG_DD as usize] = Some(TagHandler {
    spacing: Some([0, 1]),
    ..NONE
  });
